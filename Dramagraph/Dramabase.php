...
.rolerate .role5 { background-color: rgba(128, 128, 128, 0.5); border-bottom: none; color: rgba(255, 255, 255, 1); }
  ...
  public function charline($playcode, $width=150, $heightref=800) {
    ...
    echo '
<style>
.charline { font-family: sans-serif; font-size: 13px; line-height: 1.2em;  }
...
b.n { display: absolute; margin-left: -1ex; z-index: -1; font-weight: bold; color: #999; }
...
.charline a.cast { display: block; height: 100%; float: left; }
